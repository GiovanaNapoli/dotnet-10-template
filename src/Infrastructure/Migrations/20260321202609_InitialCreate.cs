        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TX_CREATED_BY = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DT_CREATED_AT = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TX_UPDATED_BY = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DT_UPDATED_AT = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TB_USERS", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TB_USERS_ImageFile_ProfilePictureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_USERS_ProfilePictureId",
                schema: "dbo",
                table: "TB_USERS",
